...
class CollapsibleBox(QWidget):
    ...
    def set_expanded(self, expanded: bool, animate: bool):
        self.toggle_button.setArrowType(Qt.DownArrow if expanded else Qt.RightArrow)
        end_height = self.content_area.layout().sizeHint().height() if expanded else 0
        if animate:
            self.anim.stop()
...
class ChartWidget(QWidget):
    ...
    def plot_timeseries(self, daily_df: pd.DataFrame, metric: str):
        self.ax.clear()
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        chart_row.addWidget(self.chart, 2)
    ...
    def config_path(self) -> str:
        return os.path.join(os.path.dirname(__file__), "sim_income_analyser_config.json")
    ...
    def update_summaries(self):
        ...
        if view is None or view.empty:
            ...
            self.chart.plot_timeseries(pd.DataFrame(), "NetIncome")
        ...
        metric = self.metric_combo.currentText() or "NetIncome"
        ...
        self.chart.plot_timeseries(daily, metric)
